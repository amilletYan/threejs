function dreamTree(){
	...
	this.initTree=function(){
		...
		var stretch_factor = 2000 / canvas_height;

		var y_speed = 10 / stretch_factor;
		...
		for (var i = 0; i < 3; i++) {
                                                                                                    //粗细
			new Branch(new Vector(center_x, canvas_height), new Vector(Math.random(-1, 1), -y_speed), 25/ stretch_factor, Branch.randomrgba(0, 255, 0.3), t);
